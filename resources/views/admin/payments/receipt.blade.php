...
<body>
    ...
    <main class="page">
        <section class="top">
            ...
            <div class="doc-title">
                ...
                <div class="meta">
                    ...
                    <p>{{ optional($payment->paid_at)->format('d M Y H:i') ?? now()->format('d M Y H:i') }}</p>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            ...
            <div class="total">
                Paid: Rp{{ number_format($payment->amount, 0, ',', '.') }}
            </div>
        </section>

        <section class="footer">
            E-receipt ini merupakan bukti pembayaran yang diterbitkan oleh Reframing Academy.
        </section>
    </main>
</body>
</html>
