        ...
        <tr>
            <td align="center">
                <table role="presentation" width="680" cellspacing="0" cellpadding="0" style="width:680px; max-width:680px; background:#ffffff; border-radius:24px; overflow:hidden; border:1px solid #e7edf2;">
                    <tr>
                        <td style="background:#15803d; padding:32px 36px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <div style="color:#dcfce7; font-size:11px; font-weight:800; letter-spacing:1.6px; text-transform:uppercase;">
                                            Reframing Physio
                                        </div>
                                    ...
                                    <td align="right">
                                        ...
                                        <div style="margin-top:6px; color:#dcfce7; font-size:13px; font-weight:700;">
                    ...
                    <tr>
                        <td style="padding:34px 36px;">
                            <div style="border:1px solid #bbf7d0; background:#ecfdf5; border-radius:18px; padding:18px; margin-bottom:24px;">
                                <div style="color:#15803d; font-size:18px; font-weight:900;">
                                    Payment Received
                                </div>
                                <div style="margin-top:7px; color:#166534; font-size:13px; line-height:1.7;">
                                    Pembayaran Anda telah kami terima. Berikut detail e-receipt untuk program Reframing Academy.
                                </div>
                            </div>
                            ...
                            <p style="margin:12px 0 0; color:#5f7283; font-size:14px; line-height:1.7;">
                                Terima kasih. Pembayaran Anda telah diterima oleh Reframing Academy.
                                Simpan email dan lampiran e-receipt ini sebagai bukti pembayaran.
                            </p>
                                ...
                                <tr>
                                    <td width="50%" style="padding-right:8px;">
                                        <div style="border:1px solid #e7edf2; background:#f8fbfd; border-radius:18px; padding:18px;">
                                            <div style="color:#738292; font-size:11px; font-weight:900; text-transform:uppercase; letter-spacing:0.8px;">Received From</div>
                                    ...
                                    <td width="50%" style="padding-left:8px;">
                                        <div style="border:1px solid #e7edf2; background:#f8fbfd; border-radius:18px; padding:18px;">
                                            <div style="color:#738292; font-size:11px; font-weight:900; text-transform:uppercase; letter-spacing:0.8px;">Receipt Detail</div>
                                            <div style="margin-top:8px; color:#123a56; font-size:14px; font-weight:800; line-height:1.55;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top:24px; border-collapse:collapse; border:1px solid #e7edf2; border-radius:16px; overflow:hidden;">
                                <tr>
                                    <td style="background:#15803d; color:#ffffff; padding:13px 14px; font-size:12px; font-weight:900; text-transform:uppercase;">Program</td>
                                    <td style="background:#15803d; color:#ffffff; padding:13px 14px; font-size:12px; font-weight:900; text-transform:uppercase;">Batch</td>
                                    <td align="right" style="background:#15803d; color:#ffffff; padding:13px 14px; font-size:12px; font-weight:900; text-transform:uppercase;">Paid Amount</td>
                                </tr>
                                ...
                                <tr>
                                    <td align="right">
                                        <table role="presentation" width="360" cellspacing="0" cellpadding="0" style="width:360px; border:1px solid #e7edf2; border-radius:16px; overflow:hidden;">
                                            ...
                                            <tr>
                                                <td style="padding:16px 15px; background:#ecfdf5; color:#15803d; font-size:16px; font-weight:900; border-top:1px solid #e7edf2;">Paid Amount</td>
                                                <td align="right" style="padding:16px 15px; background:#ecfdf5; color:#15803d; font-size:16px; font-weight:900; border-top:1px solid #e7edf2;">Rp{{ number_format($paidAmount, 0, ',', '.') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <div style="margin-top:24px; border:1px solid #d9edf6; background:#edf7fb; border-radius:18px; padding:18px; color:#31596f; font-size:13px; line-height:1.7;">
                                <strong>Catatan E-Receipt</strong><br>
                                E-receipt ini diterbitkan sebagai bukti pembayaran yang telah diterima oleh Reframing Academy.
                    ...
                    <tr>
                        <td style="padding:20px 36px; background:#f8fbfd; border-top:1px solid #e7edf2; color:#738292; font-size:12px; line-height:1.6;">
                            Email ini dikirim otomatis oleh sistem Reframing Academy. Simpan email dan lampiran e-receipt sebagai bukti pembayaran.
                        </td>
                    </tr>
                </table>
            </td>
